...
export function Room(){
    ...
    async function handleCreateSendQuestion(event:FormEvent){
        ...
        if(newQuestion.trim() === ""){
            alert('Sua pergunta não pode estar vazia!')
            return;
        }
        ...
        //database.ref é o que cria a sala
        //verificar a api de database do firebase posteriormente
                     ...
                     <div className="form-footer">
                         {
                            user ? (<div className="user-info">
                                ...
                                <span>{user.name}</span>
                            </div>) : (<span>Para enviar uma pergunta faça seu <button>login</button></span> )
                         }
